...
declare class __sveltets_Render<TParentData, TName extends DeepKeys<TParentData>, TFieldValidator extends Validator<DeepValue<TParentData, TName>, unknown> | undefined = undefined, TFormValidator extends Validator<TParentData, unknown> | undefined = undefined, TData extends DeepValue<TParentData, TName> = DeepValue<TParentData, TName>> {
    props(): FieldComponentProps<TParentData, TName, TFieldValidator, TFormValidator, TData>;
    events(): {};
    slots(): {};
    bindings(): "";
    exports(): {};
...
type Field<TParentData, TName extends DeepKeys<TParentData>, TFieldValidator extends Validator<DeepValue<TParentData, TName>, unknown> | undefined = undefined, TFormValidator extends Validator<TParentData, unknown> | undefined = undefined, TData extends DeepValue<TParentData, TName> = DeepValue<TParentData, TName>> = InstanceType<typeof Field<TParentData, TName, TFieldValidator, TFormValidator, TData>>;
